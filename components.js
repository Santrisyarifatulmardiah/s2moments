...
const Components = {
    ...
    renderCatalog() {
        return `
            <section id="catalog" class="py-10 sm:py-14 md:py-16 bg-section-alt" x-data="{ activeCatalog: 'wedding', activeTab: 'luxee' }">
                <div class="container mx-auto px-4 sm:px-6">
                    <!-- Section Header -->
                    ...
                    <div class="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mb-8 sm:mb-10 max-w-2xl mx-auto scroll-animate">
                        ...
                        <button @click="activeCatalog = 'wedding'; activeTab = 'luxee'"
                    ...
                    <div x-show="activeCatalog === 'wedding'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform scale-95" x-transition:enter-end="opacity-100 transform scale-100">
                        <div class="flex flex-wrap justify-center gap-2 sm:gap-3 md:gap-4 mb-6 sm:mb-8 scroll-animate overflow-x-auto pb-2">
                            <button @click="activeTab = 'luxee'" :class="{'btn-gradient-gold text-white shadow-md': activeTab === 'luxee', 'bg-white text-brand-dark hover:bg-gray-100': activeTab !== 'luxee'}" class="px-4 sm:px-6 py-2 sm:py-2.5 rounded-full font-semibold transition text-xs sm:text-sm whitespace-nowrap">Tema Luxee</button>
    ...
    renderThemes() {
        ...
        return `
            <section id="themes" class="py-10 sm:py-14 md:py-16 bg-section-alt">
                <div class="container mx-auto px-4 sm:px-6" x-data="{ activeTab: 'luxee' }">
